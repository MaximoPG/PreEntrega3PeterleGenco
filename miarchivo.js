...
function executeGame(){
   ...
   if(
    ...
    {   
        ...
        result.innerText = player1?"Gana jugador X!":"Gana jugador 0!";
        instructor.innerText="";
        return;
    }

    if(count == 9){
        result.innerText ="¡TA TE TI!";
        gameOver.style.display = "flex";
        instructor.innerText="";
        return;
    }
    ...
    if(player1){
        instructor.innerText="Turno jugador X!"
    }else{
        instructor.innerText = "Turno jugador 0!";
    }
}
